...
public final class Sodium {
  ...
  public static final int crypto_box_curve25519xsalsa20poly1305_ZEROBYTES =
...
*/
  ...
  public static native int crypto_box_seed_keypair(byte[] privateKey, byte[] publicKey,
      byte[] seed);

  public static native int crypto_box_keypair(byte[] privateKey, byte[] publicKey);

  public static native int crypto_box_easy(byte[] ciphertext, byte[] plaintext, byte[] nonce,
      byte[] receiverPublicKey, byte[] senderPrivateKey);

  public static native int crypto_box_open_easy(byte[] plaintext, byte[] ciphertext, byte[] nonce,
      byte[] senderPublicKey, byte[] receiverPrivateKey);

  public static native int crypto_box_detached(byte[] ciphertext, byte[] mac, byte[] plaintext,
      byte[] nonce, byte[] receiverPublicKey, byte[] senderPrivateKey);

  public static native int crypto_box_open_detached(byte[] plaintext, byte[] ciphertext, byte[] mac,
      byte[] nonce, byte[] senderPublicKey, byte[] receiverPrivateKey);

  /* -- Precomputation interface -- */

  public static final int crypto_box_BEFORENMBYTES = crypto_box_curve25519xsalsa20poly1305_BEFORENMBYTES;

  public static native int crypto_box_beforenm(byte[] precomputeKey, byte[] publicKey,
      byte[] secretKey);

  public static native int crypto_box_easy_afternm(byte[] ciphertext, byte[] plaintext,
      byte[] nonce, byte[] precomputeKey);

  public static native int crypto_box_open_easy_afternm(byte[] plaintext, byte[] ciphertext,
      byte[] nonce, byte[] precomputeKey);

  public static native int crypto_box_detached_afternm(byte[] ciphertext, byte[] mac,
      byte[] plaintext, byte[] nonce, byte[] precomputeKey);

  public static native int crypto_box_open_detached_afternm(byte[] plaintext, byte[] ciphertext,
      byte[] mac, byte[] nonce, byte[] precomputeKey);
  ...
  public static native int crypto_box_seal_open(byte[] plaintext, byte[] ciphertext,
  ...
  public static native int crypto_box(byte[] ciphertext, byte[] plaintext, byte[] nonce,
      byte[] publicKey, byte[] privateKey);

  public static native int crypto_box_open(byte[] plaintext, byte[] ciphertext, byte[] nonce,
      byte[] publicKey, byte[] privateKey);

  public static native int crypto_box_afternm(byte[] ciphertext, byte[] plaintext, byte[] nonce,
      byte[] precomputeKey);

  public static native int crypto_box_open_afternm(byte[] plaintext, byte[] ciphertext,
      byte[] nonce, byte[] precomputeKey);
  ...
  public static native int crypto_core_hsalsa20(byte[] out, byte[] in, byte[] keyBytes,
      byte[] constBytes);
  ...
  public static native int crypto_core_hchacha20(byte[] out, byte[] in, byte[] keyBytes,
      byte[] constBytes);
  ...
  public static native int crypto_core_salsa20(byte[] out, byte[] in, byte[] keyBytes,
      byte[] constBytes);
  ...
  public static native int crypto_core_salsa2012(byte[] out, byte[] in, byte[] keyBytes,
      byte[] constBytes);
  ...
  public static native int crypto_core_salsa208(byte[] out, byte[] in, byte[] keyBytes,
      byte[] constBytes);
  ...
  public final static native int crypto_generichash_blake2b_salt_personal(byte[] out, int out_len,
      byte[] in, int in_len, byte[] key, int key_len, byte[] salt, byte[] person, int person_len);

  //    public static native int crypto_generichash_blake2b_salt_personal(byte[] );
  ...
  /**
   * public static int crypto_generichash() { return crypto_generichash_blake2b(); }
   *
   * public static int crypto_generichash_init() { return crypto_generichash_blake2b_init(); }
   *
   * public static int crypto_generichash_update() { return crypto_generichash_blake2b_update(); }
   *
   * public static int crypto_generichash_final() { return crypto_generichash_blake2b_final(); }
   */
  ...
  public static native int crypto_hash_sha256_update(byte[] state, byte[] in, int inOffset,
      int inLimit);
  ...
  public static native int crypto_hash_sha512_update(byte[] state, byte[] in, int inOffset,
      int inLimit);
  ...
  public static native int crypto_secretbox_easy(byte[] ciphertext, byte[] plaintext, byte[] nonce,
      byte[] sharedKey);

  //crypto_secretbox_open_easy(decrypted, ciphertext, CIPHERTEXT_LEN, nonce, key)
  public static native int crypto_secretbox_open_easy(byte[] plaintext, byte[] ciphertext,
      byte[] nonce, byte[] sharedKey);
...
*/
  ...
  public static native int crypto_sign_seed_keypair(byte[] publicKey, byte[] secretKey,
      byte[] seed);
  ...
  public static native int crypto_sign_verify_detached(byte[] signature, byte[] message,
      byte[] publicKey);
...
*/
  ...
  public static native final int int_test();
}
